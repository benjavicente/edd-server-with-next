...
def check_improvement(graph, jsonfile, testfile, cost):
    ...
    print(f'Score: {(suma/comparador[key]["obj"])}', file=out)
    print(f'Sum: {suma}', file=out)
    print(f'Obj: {comparador[key]["obj"]}', file=out)
    if (suma/comparador[key]["obj"]) > 1.35:
        ...
        return "CORRECT", suma/comparador[key]["obj"]
...
if __name__ == '__main__':
    ...
    test_file_path = f'tests/P1/{test_file}.txt'
    output_file_path = 'output.txt'
    jsonfile = 'tests/paths/costs.json'
